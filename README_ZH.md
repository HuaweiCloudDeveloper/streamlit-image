 <h1 align="center">Streamlit数据科学应用工具</h1>
  <p align="center">
...
[Streamlit](https://github.com/streamlit/streamlit) 是一个用于创建数据应用和机器学习模型界面的开源 Python 库。它允许开发者快速构建交互式Web应用，而无需深入了解前端开发技术。商品部署基于arm架构的Huawei Cloud EulerOS 2.0 64bit系统。

**为什么选择 Streamlit？**

**‌简单且符合 Python 风格：**  编写简洁、易读的代码。

**‌快速、交互式原型验证：**  让他人与您的数据进行快速交互并获取反馈。

**‌实时编辑：**  在编辑脚本时即时查看应用的更新。
